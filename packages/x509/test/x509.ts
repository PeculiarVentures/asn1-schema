...
describe("x509", () => {
  it("cert #1", () => {
    ...
    const cert = AsnParser.parse(Convert.FromBase64(pem), src.Certificate);
  ...
  it("Extended key usages", () => {
    ...
    const eku = AsnParser.parse(Convert.FromHex(hex), src.ExtendedKeyUsage);
