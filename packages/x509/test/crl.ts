...
describe("crl", () => {
   ...
   */
  const crlExtRaw = Convert.FromBase64Url(
    "_Y21kPWNybCZpc3N1ZXI9Q04lM0RQZWN1bGlhcitWZW50dXJlcytSb290K0NBKy0rUjEwgYYGA1UdLgR_MH0we6B5oHeGdWh0dHA6Ly9rYXJhLnByaW1la2V5LnNlOjgwODAvZWpiY2EvcHVibGljd2ViL3dlYmRpc3QvY2VydGRpc3Q_Y21kPWRlbHRhY3JsJmlzc3Vlcj1DTiUzRFBlY3VsaWFyK1ZlbnR1cmVzK1Jvb3QrQ0ErLStSMTANBgkqhkiG9w0BAQsFAAOCAQEAmkPdMs7sgbfYWCPSlC_jMGVGg_C2yvD7Z-vqM21bF5muSiFvvmiDnrmaDwZmaxvVrqwXzgRfggKqP5SlYzIqjyejcbpCc6pouYu3LA7Lt9UncbVvw_dNYc0x7u1VB1e9XdV1W1OdKrhlz1O4dszsxvnuaYQQU7E3zyeOrtmKKznMo3CFYr3yGsrojvvZ3dM-toTUCZnVLg1TBkuS2XcMwQCdqaKFZUTQmkfvktQLTtdXiOgW050kpLR8HA23AuzHcvvrHp7GCuIGjmXCEXRB39BNzfmMs5wD4cN0sCmNURM821OF93KEWg93HFZik9SoSdAyxSPUSt3wz2W41e-vCw",
  );
  /**
   * Certs: 4
   * Extensions: authorityKeyIdentifier, deltaCRLIndicator, cRLNumber
   */
  const crlExtDeltaRaw = Convert.FromBase64(
    "",
  );
  /**
   * Certs: 3
   * Extensions: authorityKeyIdentifier, cRLNumber
   */
  const crlCertsRaw = Convert.FromBase64Url(
  ...
  describe("parse extensions", () => {
    ...
    it("authorityKeyIdentifier", () => {
      ...
      assert.strictEqual(
        Convert.ToHex(aki.keyIdentifier),
    ...
    it("issuingDistributionPoint", () => {
      ...
      assert.strictEqual(
        ...
        "http://kara.primekey.se:8080/ejbca/publicweb/webdist/certdist?cmd=crl&issuer=CN%3DPeculiar+Ventures+Root+CA+-+R1",
      );
    });
    ...
    it("freshestCRL", () => {
      ...
      assert.strictEqual(
        freshest[0].distributionPoint?.fullName?.[0].uniformResourceIdentifier,
        "http://kara.primekey.se:8080/ejbca/publicweb/webdist/certdist?cmd=deltacrl&issuer=CN%3DPeculiar+Ventures+Root+CA+-+R1",
      );
    });
  });
