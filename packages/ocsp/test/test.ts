...
import {
  AsnParser, AsnSerializer, OctetString,
  ...
  it("request build", () => {
    const request = new OCSPRequest({
      tbsRequest: new TBSRequest({
        requestorName: new GeneralName({ iPAddress: "1.0.1.0" }),
        requestList: [
          new Request({
            reqCert: new CertID({
    ...
    assert.strictEqual(
      encoding.hex.encode(der),
      "302b3029a106870401000100301f301d301b300706052b0e03021a04047f01020304047f01020302047f010203",
    );
  });
});
